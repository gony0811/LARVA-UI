...
namespace EPLE.IO
{
    public class DataManager : IDisposable
    {
        ...
        public bool SET_BOOL_DATA(string name, bool value, bool setDefaultValue)
        {
            bool result = false;
            Data data;
            int iValue = value? 1 : 0;
            ...
            else
            {
                if (DeviceManager.Instance.SetDataToDevice(name, iValue))
                {
                    ...
                    if (setDefaultValue)
                    {
                        CHANGE_DEFAULT_DATA(name, iValue);
                    }
                }
                else
                {
        ...
        public bool SET_INT_DATA(string name, int value, bool setDefaultValue)
        {
            bool result = false;
            Data data;
            ...
            else
            {
                if (DeviceManager.Instance.SetDataToDevice(name, value))
                {
                    ...
                    {
                        CHANGE_DEFAULT_DATA(name, value);
                    }
                }
                else
                {
        ...
        public bool SET_DOUBLE_DATA(string name, double value, bool setDefaultValue)
        {
            bool result = false;
            if (!_dataAccess.RemoteObject.GetData(name, out Data data))
                return false;
        ...
        public bool SET_STRING_DATA(string name, string value, bool setDefaultValue)
        {
