...
{
    public class F_SERVO_Y_OFF : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nYOff_Req;
        private string reply_io_name = IoNameHelper.iServo_nYOff_Reply;

        public F_SERVO_Y_OFF()
        {
