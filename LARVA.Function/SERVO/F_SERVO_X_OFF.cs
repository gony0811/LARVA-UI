...
{
    public class F_SERVO_X_OFF : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nXOff_Req;
        private string reply_io_name = IoNameHelper.iServo_nXOff_Reply;

        public F_SERVO_X_OFF()
        {
