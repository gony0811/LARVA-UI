...
{
    public class F_SERVO_X_ON : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nXOn_Req;
        private string reply_io_name = IoNameHelper.iServo_nXOn_Reply;
