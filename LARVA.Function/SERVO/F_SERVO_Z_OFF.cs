...
{
    public class F_SERVO_Z_OFF : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nZOff_Req;
        private string reply_io_name = IoNameHelper.iServo_nZOff_Reply;

        public F_SERVO_Z_OFF()
        {
