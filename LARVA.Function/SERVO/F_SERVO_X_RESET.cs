...
{
    public class F_SERVO_X_RESET : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nXReset_Req;
        private string reply_io_name = IoNameHelper.iServo_nXReset_Reply;

        public F_SERVO_X_RESET()
        {
