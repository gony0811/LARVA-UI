...
{
    public class F_SERVO_X_HALT : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nXHalt_Req;
        private string reply_io_name = IoNameHelper.iServo_nXHalt_Reply;

        public F_SERVO_X_HALT()
        {
