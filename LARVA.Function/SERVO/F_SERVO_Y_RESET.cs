...
{
    public class F_SERVO_Y_RESET : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nYReset_Req;
        private string reply_io_name = IoNameHelper.iServo_nYReset_Reply;

        public F_SERVO_Y_RESET()
        {
