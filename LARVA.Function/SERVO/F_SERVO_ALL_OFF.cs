...
{
    public class F_SERVO_ALL_OFF : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nAllOff_Req;
        private string reply_io_name = IoNameHelper.iServo_nAllOff_Reply;

        public F_SERVO_ALL_OFF()
        {
