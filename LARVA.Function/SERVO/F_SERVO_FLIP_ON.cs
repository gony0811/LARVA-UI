...
{
    public class F_SERVO_FLIP_ON : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nFlipOn_Req;
        private string reply_io_name = IoNameHelper.iServo_nFlipOn_Reply;

        public F_SERVO_FLIP_ON()
        {
