...
{
    public class F_SERVO_Y_HALT : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nYHalt_Req;
        private string reply_io_name = IoNameHelper.iServo_nYHalt_Reply;

        public F_SERVO_Y_HALT()
        {
