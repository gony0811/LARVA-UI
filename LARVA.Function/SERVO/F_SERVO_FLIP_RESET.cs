...
{
    public class F_SERVO_FLIP_RESET : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nFlipReset_Req;
        private string reply_io_name = IoNameHelper.iServo_nFlipReset_Reply;

        public F_SERVO_FLIP_RESET()
        {
