...
{
    public class F_SERVO_ALL_RESET : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nAllReset_Req;
        private string reply_io_name = IoNameHelper.iServo_nAllReset_Reply;

        public F_SERVO_ALL_RESET()
        {
