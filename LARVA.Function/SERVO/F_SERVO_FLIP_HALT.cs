...
{
    public class F_SERVO_FLIP_HALT : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nFlipHalt_Req;
        private string reply_io_name = IoNameHelper.iServo_nFlipHalt_Reply;

        public F_SERVO_FLIP_HALT()
        {
