...
{
    public class F_SERVO_FLIP_OFF : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nFlipOff_Req;
        private string reply_io_name = IoNameHelper.iServo_nFlipOff_Reply;

        public F_SERVO_FLIP_OFF()
        {
