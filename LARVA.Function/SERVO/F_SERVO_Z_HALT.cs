...
{
    public class F_SERVO_Z_HALT : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oServo_nZHalt_Req;
        private string reply_io_name = IoNameHelper.iServo_nZHalt_Reply;

        public F_SERVO_Z_HALT()
        {
