...
namespace EPLE.Core.Manager
{
    public class LocationManager
    {
        ...
        public LOCATION_INFO GetLocation(int location_id)
        {
            return _locationList.Find((loc) => loc.LOCATION_ID == location_id);
        }

        public LOCATION_INFO GetLocationByName(string location_name)
        {
            return _locationList.Find((loc) => loc.LOCATION_NAME == location_name);
        }
